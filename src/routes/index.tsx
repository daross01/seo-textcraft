...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "PostText Generator | TextCraft Generator" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "PostText Generator" },
      {
  ...
  return (
    <main className="mx-auto max-w-6xl space-y-8 px-5 py-10">
      <header className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-widest text-accent">PostText Generator</p>
        <h1 className="text-3xl font-extrabold tracking-tight">PostText Generator</h1>
