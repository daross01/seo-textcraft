...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Wallpaper Content CSV Generator | Wallcraft Studio" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Wallpaper Content CSV Generator" },
      {
  ...
  return (
    <main className="mx-auto max-w-6xl space-y-8 px-5 py-10">
      <header className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-widest text-accent">Tool A</p>
        <h1 className="text-3xl font-extrabold tracking-tight">Wallpaper Content CSV Generator</h1>
